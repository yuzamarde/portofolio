                                ...
                                <tr v-for="cart in carts" :key="cart.id" style="background: #edf2f7;">
                                    ...
                                    <td class="b-none" width="50%">
                                        ...
                                        <table class="table-borderless" style="font-size: 14px">
                                            <tr>
                                                <td style="padding: .20rem"><b>{{ cart.type1 }}</b></td>
                                                
                                                <td style="padding: .20rem"></td>
                                                <td style="padding: .20rem"><b>{{ cart.type2 }}</b></td>
                                                <td style="padding: .20rem"></td>
                                    ...
                                    <td class="b-none text-right">
                                        <p class="m-0 font-weight-bold" >Rp. {{ moneyFormat(cart.product.price * cart.quantity) }}
                                        </p>
                                        ...
                                        <div class="text-right">
                                            <button @click.prevent="removeCart(cart.id)" class="btn btn-sm btn-danger" style="padding: 5px 5px;font-size: 15px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="data form-control" id="nama_lengkap" placeholder="Nama Lengkap"
                                        v-model="state.name">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="data form-control" v-model="state.province_id" @change="getCities">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="data form-control" v-model="state.city_id" @change="getCourier">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" v-if="state.courier">
                                    ...
                                    <div class="form-check form-check-inline" style="display: flex;">
                                        <input class="data form-check-input select-courier" type="radio" name="courier"
                            ...
                            <div v-if="state.buttonCheckout" class="col-md-12">
                                <button @click.prevent="checkout" class="btn btn-primary btn-lg btn-block" style="display: inline;" >CHECKOUT</button>
                            </div>
